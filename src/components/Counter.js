        ...
        <div className='main'>  
            <table className='table-wrapper'>
                <tbody>
                    ...
                    <tr>
                        <td className='count'>{rizeCount}</td>
                        <td className='count'>{reviewtrackersCount}</td>
                        <td className='count'>{reviewshakeCount}</td>
                        <td className='count'>{gradeUsCount}</td>
                        <td className='count'>{whitelabelCount}</td>
                    </tr>
                    <tr>
